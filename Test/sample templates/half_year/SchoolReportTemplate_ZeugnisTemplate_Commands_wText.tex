\newcommand{\schoolReportDay}{31.01.2025}
...
\newcommand{\gradeNotGiven}{& \multicolumn{4}{p{0.28\linewidth}|}{\centering nicht erteilt}\\}
...
\newcommand\competencyTableMajorSubject[3]{\small
	...
	\begin{tabularx}{\linewidth}{|K{X}|C{\tableGradeWidthLevel}|C{\tableGradeWidth}|C{\tableGradeWidth}|C{\tableGradeWidth}|C{\tableGradeWidth}|}
		\hline
		\multicolumn{6}{|>{\columncolor{egelightblue}}p{0.975\linewidth}|}{\textit{\textbf{#1}}} \\
		\hline
		#2
		\levelRow{#3}
...
\newcommand\competencyTableMajorSubjectText[2]{\small
	\renewcommand{\arraystretch}{1.5}
	\begin{tabularx}{\linewidth}{|K{X}|C{\tableGradeWidthLevel}|C{\tableGradeWidth}|C{\tableGradeWidth}|C{\tableGradeWidth}|C{\tableGradeWidth}|}
		\hline
		\multicolumn{6}{|>{\columncolor{egelightblue}}p{0.975\linewidth}|}{\textit{\textbf{#1}}} \\
